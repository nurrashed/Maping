...
//const cycling1 = new Cycling([39, -12], 27, 90, 520);
...
class App {
  ...
  _setLocalStorage(){
      //Converting object to a sting we use JSON.stringify method
      //inside the setItem 'workouts' is a key string. 
      localStorage.setItem('workouts', JSON.stringify(this.#workouts)) // just by doing so all the workouts will be stored in the local storage
  };
